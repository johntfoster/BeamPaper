...
\begin{figure}[h]
\centering
\resizebox{\linewidth}{!}{\subinputfrom{\diagrampath}{simpleBondPair.eps_tex}}
...
\begin{figure}[h]
\centering
\resizebox{\linewidth}{!}{\subinputfrom{\diagrampath}{bondPair.eps_tex}}
...
%
\begin{figure}[h]
\resizebox{\linewidth}{!}{\subinputfrom{\diagrampath}{EulerBending.eps_tex}}
...
\begin{figure}[h]
  \centering
  \resizebox{\linewidth}{!}{\input{\plotpath/unloaded2_h10_g2000_n.pgf}}
...
\begin{figure}[h]
  \centering
  \resizebox{\linewidth}{!}{\input{\plotpath/unloaded2_n1000_g2000_h.pgf}}
